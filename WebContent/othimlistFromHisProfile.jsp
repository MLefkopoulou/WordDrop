...
<!DOCTYPE html>
<html>
  <title>User's List (Profile)</title>
  <meta charset="UTF-8">
...
.footer {
  flex-shrink: 0;
    ...
    .modal-body, .modal-body2 {padding: 2px 16px;}
...
String special_tag ;
special_tag= (String)request.getAttribute("special_tag_his");
...
%>
    ...
    <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px;top:38px" id="mySidebar">
      ...
      <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
        ...
        <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn3">
          <%=special_tag %> <i class="fa fa-caret-down"></i>
        </a>
        <div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
        <%
        	ArrayList<UserList>  current_lists = ( ArrayList<UserList>) session.getAttribute("current_lists_his");
        	session.setAttribute("current_lists_his",current_lists);
    ...
    <div class="w3-main" style="margin-left:250px;padding-top:38px">
        ...
        <div style="text-align:left; padding-left:25px"><i class="fa fa-user"> </i> <%=listOwner%></div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="w3-container w3-card-4 w3-padding-16 w3-white"
						...
						<input type="hidden" name="page" value="his">
            ...
            <%
                ...
                <tr>
                    ...
                    <%	String exte = im_path.substring(im_path.lastIndexOf(".")+1);
                   	...
                   	%>
                    	<!-- <th> <img src="no_image.png" alt="no image yet" style="width:20% "></th> -->
                    	<td><img src="no_image.png" alt="no image yet" style="width: 30%;"></td>
               		<%}else{ %>
               			<%-- <th> <img src="/UserData/<%=im_path %>" alt="no image yet" style="width:20% "></th> --%>
