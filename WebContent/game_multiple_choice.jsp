...
%>
	<div class="w3-main" style="padding-top: 38px">
		<h2 id="game_title"  style="text-align:center;  font-weight: bolder; color:teal;">MULTIPLE CHOISE</h2>
 		<h4   style="text-align:center; font-weight: bolder; "><%=listname%></h4>
    <div id="container">
        <a id="start" onclick="startQuiz('<%=que3%>')"  href="javascript:void(0)" class = "center">Start Quiz! </a>
